...
#define CONFIG_RAMDUMP_BACKTRACE_MAGIC			(CONFIG_RAMDUMP_BASE + 0x2A0)
#define CONFIG_RAMDUMP_BACKTRACE_CPU			(CONFIG_RAMDUMP_BASE + 0x2A4)
#define CONFIG_RAMDUMP_BACKTRACE_PADDR			(CONFIG_RAMDUMP_BASE + 0x2A8)
#define CONFIG_RAMDUMP_BACKTRACE_SIZE			(CONFIG_RAMDUMP_BASE + 0x2B0)
...
#define CONFIG_RAMDUMP_MINITMON_BASE                    (CONFIG_RAMDUMP_BASE + 0xB800)
#define CONFIG_RAMDUMP_STACK				(CONFIG_RAMDUMP_BASE + 0x10000)
#define CONFIG_RAMDUMP_DEBUG_KINFO_BASE			(0xFCFFF000)
