...
#define EXYNOS3830_GPIO_CMGP_BASE						0x11C30000
...
#define EXYNOS3830_GPP0CON							(EXYNOS3830_GPIO_PERI_BASE + 0x0020)
#define EXYNOS3830_GPP1CON							(EXYNOS3830_GPIO_PERI_BASE + 0x0040)
#define EXYNOS3830_GPC1CON							(EXYNOS3830_GPIO_PERI_BASE + 0x0100)
#define EXYNOS3830_GPM0CON							(EXYNOS3830_GPIO_CMGP_BASE + 0x0000)
#define EXYNOS3830_GPM1CON							(EXYNOS3830_GPIO_CMGP_BASE + 0x0020)
#define EXYNOS3830_GPM4CON							(EXYNOS3830_GPIO_CMGP_BASE + 0x0080)
#define EXYNOS3830_GPM5CON							(EXYNOS3830_GPIO_CMGP_BASE + 0x00A0)
 ...
 * reboot mode
 */
#define REBOOT_MODE_RECOVERY	0x1
#define REBOOT_MODE_FACTORY	0x2
#define REBOOT_MODE_FASTBOOT	0x3
#define REBOOT_MODE_CHARGER	0x4
#define REBOOT_MODE_FASTBOOT_USER	0x5
...
/* Sysreg */
#define EXYNOS3830_SYSREG_PERI_BASE			0x10020000
#define EXYNOS3830_SYSREG_CMGP_BASE			0x11C20000
#define EXYNOS3830_HSI2C_0_SW_CONF			(EXYNOS3830_SYSREG_PERI_BASE + 0x1020)
#define EXYNOS3830_HSI2C_1_SW_CONF			(EXYNOS3830_SYSREG_PERI_BASE + 0x1030)
#define EXYNOS3830_HSI2C_2_SW_CONF			(EXYNOS3830_SYSREG_PERI_BASE + 0x1040)
#define EXYNOS3830_USI_CMGP0_SW_CONF			(EXYNOS3830_SYSREG_CMGP_BASE + 0x2000)
#define EXYNOS3830_USI_CMGP1_SW_CONF			(EXYNOS3830_SYSREG_CMGP_BASE + 0x2010)

/* HSI2C */
#define EXYNOS3830_BLK_PERI_HSI2C_BASE			0x138A0000
#define EXYNOS3830_BLK_CMGP_USI_BASE			0x11D00000
#define EXYNOS3830_BLK_HSI2C_0				(EXYNOS3830_BLK_PERI_HSI2C_BASE + 0x00000)
#define EXYNOS3830_BLK_HSI2C_1				(EXYNOS3830_BLK_PERI_HSI2C_BASE + 0x10000)
#define EXYNOS3830_BLK_HSI2C_2				(EXYNOS3830_BLK_PERI_HSI2C_BASE + 0x20000)
#define EXYNOS3830_BLK_USI_CMGP00			(EXYNOS3830_BLK_CMGP_USI_BASE + 0x00000)
#define EXYNOS3830_BLK_USI_CMGP01			(EXYNOS3830_BLK_CMGP_USI_BASE + 0x20000)

/* I2C */
#define EXYNOS3830_I2C_BASE				0x13830000
#define EXYNOS3830_I2C0					(EXYNOS3830_I2C_BASE + 0x00000)
#define EXYNOS3830_I2C1					(EXYNOS3830_I2C_BASE + 0x10000)
#define EXYNOS3830_I2C2					(EXYNOS3830_I2C_BASE + 0x20000)
#define EXYNOS3830_I2C3					(EXYNOS3830_I2C_BASE + 0x30000)
#define EXYNOS3830_I2C4					(EXYNOS3830_I2C_BASE + 0x40000)
#define EXYNOS3830_I2C5					(EXYNOS3830_I2C_BASE + 0x50000)
#define EXYNOS3830_I2C6					(EXYNOS3830_I2C_BASE + 0x60000)
